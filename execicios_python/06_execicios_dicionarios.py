...
print (f"A soma das notas de paula é: {total_notas}")
print (f"A média das notas de Paula foi: {media_notas:.2f}")

# EXERCÍCIOS 05 - Limpeza de Banco de Dados

produtos = {"celular": 1500, "camera": 800, "radio": 200, "fone": 100}
produtos_removidos = produtos.pop("radio")
print(f"foi removido {produtos_removidos} rádios")
